...
sd_p_calcite  <- abs(((((((data.avg.true + data.sd - Intercept) / Slope) * ifelse(is.na(total_volume), 5, total_volume * 1000 / 200)) * 10^-3) / t(t(as.numeric(dissolved[1,]))))) / 10.00869 - mmolp_molcalc) / sqrt(n)
sd_p_dolomite <- abs(((((((data.avg.true + data.sd - Intercept) / Slope) * ifelse(is.na(total_volume), 5, total_volume * 1000 / 200)) * 10^-3) / t(t(as.numeric(dissolved[1,])))))/ 18.4401 - mmolp_molcalc) / sqrt(n)
